...
first_admin_pass="$(get_value FIRST_ADMIN_PASS)"
...
[[ -n "$first_admin_pass" ]] || fail "FIRST_ADMIN_PASS must be set"
[[ "$first_admin_pass" != "replace-with-first-admin-pass" ]] || fail "FIRST_ADMIN_PASS must be replaced"
[[ ${#first_admin_pass} -ge 12 ]] || fail "FIRST_ADMIN_PASS must be at least 12 characters long"
